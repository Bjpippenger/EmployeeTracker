...
const addRoleQuestions = [
  ...
  },
  {
    ...
    name: "salary",
    message:
      'What is the salary of the new role? (numbers only please, i.e. "100000")',
  },
  {
    type: "input",
    name: "department",
    message:
      'What department is the new role in? Please type the number only of the department shown above! (i.e. "4")',
  },
];
...
const addEmployeeQuestions = [
  ...
  },
  {
    ...
    name: "role_id",
    message:
      'What role is the new employee in? Please type the number only of the "id" section shown above! (i.e. "4")',
  },
  {
    type: "input",
    name: "manager_id",
    message:
      'Who is the manager for the new employee? Please type the number only of the "id" section shown above! (i.e. "4")',
  },
];
...
const chooseEmployeeQuestion = [
  {
    ...
    name: "employee_id",
    message:
      'Which employee would you like to update? Please only type the number of the "id" of the employee! (i.e. "4")',
  },
];
    ...
    .then(function (result) {
      switch (result.startMenuQuestion) {
        ...
        case "Add an Employee":
          ...
          db.query(
            "SELECT employee.*, role.title AS role_title FROM employee LEFT JOIN role ON employee.role_id = role.id",
            function (err, results) {
              console.log("");
              console.table(results);
            }
